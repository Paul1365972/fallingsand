...
- **Topple** — a grounded grain on an open slope converts fall energy into sideways velocity by its topple friction (static/kinetic, agitation-propagated). Redirection is a force, never a swap.
